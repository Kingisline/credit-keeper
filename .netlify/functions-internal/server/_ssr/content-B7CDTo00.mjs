//#region node_modules/.nitro/vite/services/ssr/assets/content-B7CDTo00.js
var COMPANY = "Halcyon Works";
var capabilities = [
	{
		slug: "saas",
		name: "SaaS product development",
		summary: "From user problem and product strategy through UX, architecture, engineering, QA, analytics and launch — shipped in validated increments.",
		outcomes: [
	...
	},
	{
		...
		summary: "Model strategy, evaluation, retrieval-augmented generation, workflow intelligence and monitored deployment — with clear boundaries on what AI decides.",
		outcomes: [
		...
		proof: "We separate experiments, production features and custom research, and we do not promise autonomous decisions in high-stakes contexts.",
		cta: "Start a strategic conversation"
	},
	{
		slug: "automation",
		name: "Automations and operational systems",
		summary: "Repeatability, visibility and human productivity: process mapping, integrations, approvals, document processing, reporting and exception handling.",
		outcomes: [
	...
	},
	{
		...
		summary: "Positioning, acquisition, content, analytics and conversion experimentation, run as a measured program instead of disconnected campaigns.",
		outcomes: [
	...
	},
	{
		...
		summary: "Device-to-cloud architecture, telemetry pipelines, dashboards, provisioning and the operational discipline that keeps fleets healthy.",
		outcomes: [
	...
	},
	{
		...
		summary: "Research tooling, data workflows and digital health innovation delivered with explicit governance. Research support — never medical advice.",
		outcomes: [
		...
		proof: "All medical research content states its stage. We make no clinical claims and imply no regulatory approval.",
...
//#endregion
export { work as a, principles as i, approachSteps as n, capabilities as r, COMPANY as t };
